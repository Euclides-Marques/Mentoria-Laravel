...
class VendasController extends Controller
{
    ...
    {
        $findNumeracaoVenda = Venda::max('numero_da_venda') + 1;
        ...
        if($request->method() == 'POST'){
            //criar os dados
            $data = $request -> all();
            $data['numero_da_venda'] = $findNumeracaoVenda;
        ...
        //mostrar os dados
        return view('pages.vendas.create', compact('findNumeracaoVenda', 'findProduto', 'findCliente'));
    }
