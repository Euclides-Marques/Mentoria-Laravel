...
@section('content')
    ...
    <div>
        <form action="{{ route('usuarios.index') }}" method="get">
            ...
            <a href="{{ route('cadastrar.usuario') }}" type="button" class="btn btn-success float-end">
                Incluir Usuário
            </a>
        </form>
            ...
            <table class="table table-striped table-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $usuario->email }}</td>
                        <td>
                            <a href="{{ route('atualizar.usuario', $usuario->id) }}" class="btn btn-primary btn-sm">Editar</a>
